...
void function () {
  var _, addNewlineToBr, cleanParagraphText, convertToText, formatterHtml, formatterText, linksToText, removeFewwordsParagraphs, removeNegativescoresNodes, replaceWithText, stopwords, ulToText, XRegExp;
  stopwords = require('./stopwords');
  _ = require('lodash');
  XRegExp = require('xregexp').XRegExp;
  module.exports.text = formatterText = function (doc, topNode, language) {
  ...
  module.exports.html = formatterHtml = function (doc, topNode, language) {
    removeNegativescoresNodes(doc, topNode);
    removeFewwordsParagraphs(doc, topNode, language);
    return topNode.html();
  };
