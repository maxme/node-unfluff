...
void function () {
  var _, attrIsOk, cleanArticleTags, cleanBadTags, cleanCodeBlocks, cleanEmTags, cleaner, cleanErrantLinebreaks, cleanParaSpans, cleanUnderlines, divToPara, getReplacementNodes, removeAllAttributes, removeBodyClasses, removeDropCaps, removeNodeKeepChildren, removeNodesRegex, removeScriptsStyles, replaceWithPara;
  _ = require('lodash');
    ...
    return doc('*').each(function () {
      ...
      return function (accum$) {
        ...
        for (var cache$ = Object.keys(attrs), i$ = 0, length$ = cache$.length; i$ < length$; ++i$) {
          ...
          if (!attrIsOk(item))
            continue;
          accum$.push(doc(this)[0].attribs[item] = attrs[item]);
        }
        return accum$;
      }.call(this, []);
    });
