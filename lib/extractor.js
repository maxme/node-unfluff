...
void function () {
  var _, addSiblings, biggestTitleChunk, getObjectTag, getScore, getSiblingsContent, getSiblingsScore, getVideoAttrs, htmlFormatter, isBoostable, isHighlinkDensity, isNodescoreThresholdMet, isTableAndNoParaExist, postCleanup, stopwords, textFormatter, updateNodeCount, updateScore;
  _ = require('lodash');
  ...
  module.exports = {
    ...
    text: function (doc, topNode, lang) {
      if (topNode) {
        ...
        return textFormatter(doc, topNode, lang);
      } else {
        return '';
      }
    },
    clean_html: function (doc, topNode, lang) {
      if (topNode) {
        topNode = postCleanup(doc, topNode, lang);
        return htmlFormatter(doc, topNode, lang);
      } else {
        return '';
      }
    },
