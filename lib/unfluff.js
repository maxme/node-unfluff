...
void function () {
  var cheerio, extractor, getCleanedDoc, getParsedDoc, getTopNode, htmlCleaner, textCleaner, unfluff;
  ...
  module.exports = unfluff = function (html, language) {
    var doc, doc2, lng, pageData, topNode, topNode2;
  ...
  getCleanedDoc = function (html) {
    ...
    doc = getParsedDoc.call(this, html);
    this.cleanedDoc_ = textCleaner(doc);
    return this.cleanedDoc_;
  };
}.call(this);
